...
const VideoPlayer: React.FC<Props> = ({ videoSlug }: Props) => {
    const { data, loading } = useQuery<GetLessonBySlug>(GET_LESSON_QUERY, {
        variables: {
            slug: videoSlug
        }
    });
                ...
                >
                    ...
                    <div className="py-6 leading-relaxed">
                        ...
                        <p className="text-sm text-gray-200 mt-2">
                            Accesse o material complementar para acelerar o seu desenvolviemento.
                        </p>
                    </div>
